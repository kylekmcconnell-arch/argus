...
const migration = readFileSync(new URL("../supabase/migrations/20260910091456_report_subject_identity.sql", import.meta.url), "utf8");
...
const template = readFileSync(new URL("../supabase/tests/fixtures/report_subject_identity.sql.in", import.meta.url), "utf8");
