...
Native ESM dependency tests now include holder and clustering routes. They exposed extensionless shared-module imports, corrected in this change. Offline regression tests verify rank 25, unknown contracts, explorer failure/ten-holder coverage and Solana owner aggregation. Full quality: 5,302 passing tests after integration with contextual diligence plus one expected failure, seven canaries, 21 calibration cases, all types. Build passed. No paid provider calls or live bulk collection ran.
