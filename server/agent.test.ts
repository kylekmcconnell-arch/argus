      ...
      team: [
        {
          ...
          sourceUrl: "https://established.example/team",
      ...
      team: [
        {
          name: "Meow",
          role: "Co-founder",
          source: "Official Jupiter team page",
          sourceUrl: "https://jup.ag/team",
          provider: "team-page",
          evidence_origin: "deterministic",
          artifact_verified: true,
          relationshipProvenance: "subject_official",
    ...
    const packet = buildScoringEvidencePacket({
      ...
      team: [
        ...
        },
        {
          ...
          role: "core cofounder",
          provider: "team-page",
          source: "Official project founders forum",
  ...
  it("omits bare or credential-bearing links from frozen scorer artifacts", () => {
    const packet = buildScoringEvidencePacket({
      ...
      team: [{
        name: "Named Teammate",
        role: "CTO",
        linkedin: "linkedin.com/in/teammate",
        provider: "team-page",
        source: "Official project team page",
        evidence_origin: "deterministic",
        artifact_verified: true,
