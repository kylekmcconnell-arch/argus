  ...
  it("reports configuration without making provider calls", () => {
    ...
    expect(captured.body).toMatchObject({
      ...
      services: [
        ...
        { id: "openalex", ok: false, optional: true, detail: "optional fallback not configured" },
        { id: "courtlistener", ok: false, optional: true, detail: "optional fallback not configured" },
  ...
  it("reports OpenRouter routing and knowledge-base reuse when fallbacks are on", () => {
    ...
    expect(captured.body).toMatchObject({
      services: [
        ...
        { id: "resend" }, { id: "companies-house" }, { id: "openalex" }, { id: "courtlistener" }, { id: "opencorporates" },
