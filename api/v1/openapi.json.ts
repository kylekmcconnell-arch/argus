    ...
    schemas: {
      ...
      TokenAudit: {
        ...
        properties: {
          ...
          decision_ready: { type: "boolean", description: "Final verdict and score require completed token checks." },
          completeness_state: { type: "string", enum: ["complete", "partial"] },
          assessment: { type: "object", properties: { verdict: { type: "string" }, score: { type: ["number", "null"] }, note: { type: "string" } }, description: "Public assessment including provisional score and coverage note." },
          preliminary_model_signal: { type: ["object", "null"], properties: { verdict: { type: "string" }, score: { type: ["number", "null"] }, headline: { type: "string" } } },
