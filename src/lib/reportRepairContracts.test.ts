...
describe("report repair contracts",()=>{
 ...
 it("hides a DexScreener overflow market cap from presentation",()=>{expect(tokenMarketPresentation({mcap:5.5e15,fdv:5.67e9,marketEvidence:{mcap:true,fdv:true,liquidityUsd:false,vol24:false,ageDays:false}} as TokenDossier).marketCap).toBeNull();});
