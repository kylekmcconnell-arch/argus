...
// Market and custody contracts that hold token balances without being a
// holder: Uniswap V4 PoolManagers (the pool's tokens sit in the manager, not
// in a pair contract DexScreener could name), launchpad lockers and Doppler's
// book-entry LP custody. On $HADES (Robinhood, 2026-09-25) the PoolManager
// and two lockers were counted as three of the "25 fresh wallets".
export const EVM_MARKET_CONTRACTS: Record<string, MarketAddressMatch> = {
