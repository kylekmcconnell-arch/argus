    ...
    <div className="relative flex min-h-full flex-col">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-2xl flex-1 flex-col items-center px-6 pt-[11vh]">
        ...
        <p className="mt-3 max-w-lg text-center text-[14px] leading-relaxed text-ink-dim">
          Paste an X handle. ARGUS routes the subject into every role they hold and audits each on
          its own evidence, then returns a verdict you can stake money on.
        </p>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              placeholder="audit a handle, or paste an x.com/ profile url"
