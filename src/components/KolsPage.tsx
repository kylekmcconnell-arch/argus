...
export function KolsPage({ onAudit, onOpenRecent }: { onAudit: (h: string, priv?: boolean) => void; onOpenRecent?: (ref: string) => void }) {
  ...
  return (
    ...
    <div className="mx-auto max-w-4xl px-6 py-10">
      ...
      >
        ...
        <button type="submit" className="btn-primary px-3.5 py-1.5 text-[13px] font-medium">Grade calls</button>
      </form>
