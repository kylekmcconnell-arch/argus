      ...
      {open && (
        <div className="border-t border-line/60 p-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <select aria-label="Relationship" value={rel} onChange={(e) => setRel(e.target.value)} className="rounded-lg border border-line bg-panel-2/40 px-2 py-1.5 text-[11.5px] text-ink outline-none">
          ...
          <div aria-live="polite">
            ...
            {state === "pending" && <p className="mt-2 text-[11.5px]" style={{ color: "var(--color-caution)" }}>Queued for owner review — {reason}. The target is verified real, but the relationship remains unpublished and outside the graph until an owner approves it in AdminOps.</p>}
