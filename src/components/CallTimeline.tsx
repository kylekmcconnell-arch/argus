  ...
  return (
    <div className="mt-1.5">
      <div className="mb-1 flex flex-wrap items-center gap-x-2 gap-y-0.5 text-[10px] text-ink-faint">
        ...
        {d.tweetUrl && <a href={d.tweetUrl} target="_blank" rel="noreferrer" className="link-ext">the call</a>}
      </div>
