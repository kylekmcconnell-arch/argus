...
const ICONS = {
  ...
  shield: "M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6l7-3M9.5 12l1.8 1.8L15 10",
};
  ...
  return (
    ...
    >
      ...
      <nav className="space-y-0.5 px-2.5 pt-1">
        ...
        <NavItem icon="shield" label="Threat scan" active={view === "threat"} onClick={() => nav("threat")} />
