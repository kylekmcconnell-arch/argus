...
it("retains confirmed venue and observed conduct without asserting custody of an unverified pool", async () => {
  mocks.apiFetch.mockResolvedValue(new Response(JSON.stringify({ creatorVenue: "bankr", creatorFees: { claimCount: 3, claimedTokens: 100, usage: "dump", note: "Observed fixture claim and sale." } })));
