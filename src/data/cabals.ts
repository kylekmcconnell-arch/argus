...
export const CABALS: Cabal[] = [
  ...
  },
  {
    ...
    wallets: [
      ...
      { chain: RH, address: "0xfdfbcae9ed23dc88757a48b2c0cc3910e6c1afa6", role: "deployer", label: "HEY deployer, net buyer", evidence: "launchAndBuy 2026-09-09 17:35:06 took 2.53% (1% allocation + buy); moved that 2.53% to 0xd0f7d8c6… at 18:06 (still held there); bought a further ~2.8% from the pool 09-09..09-12; zero sells through 2026-09-14" },
    ...
    accounts: [
      { handle: "HeyResearch", role: "project", label: "Hey Research Lab (heyresearch.xyz), builder-intelligence site for Robinhood Chain; X since Oct 2022, 1,509 followers on 2026-09-15; the same account promoted the 2022 Ethereum HEY token", evidence: "bio carries the RH HEY CA; site shows live builder and ship counts; no tie to the snipe ring found. Lineage: post 1613594707824869376 (2023-01-12) reads '$HEY, great news for our investors! We're extending our liquidity lock for an extra year' linking heyresearch.io and an app.unicrypt.network lock; the Ethereum contract's verified source header names heytoken.pro, t.me/heyerc20 and twitter.com/heyresearch; Etherscan token page lists heyresearch.io, @HeyResearch, Medium @heyresearch and GitHub heyplatform; heyresearch.io no longer resolves (2026-09-15); the 2026 site, docs and token page carry no mention of the earlier token" },
    ],
    launches: [
      { chain: "ethereum", address: "0xe61f6e39711cec14f8d6c637c2f4568baa9ff7ee", symbol: "HEY", name: "Hey (2022 Ethereum predecessor)", launchedAt: "2022-11-01T00:00:00Z", venue: "uniswap-v2 with a Unicrypt LP lock", outcome: "unestablished", note: "The earlier token behind the same brand and X account: 'Hey Research Lab is building a research platform to help pro-trader or institution to gather obscure crypto alpha', 100M supply, MIT-licensed OpenZeppelin ERC-20 verified 2022-11-01. Roadmap promised V2 by end of Q1 2023 and a paid-research MVP (Medium, early 2023); the LP lock was extended in Jan 2023; the site went offline in Aug 2024 and the token reads $0.00 with 520 holders on 2026-09-15. Not a rug read (LP was locked and no pull was found); an abandoned project whose brand was relaunched on Robinhood Chain in Sept 2026 without disclosure", evidence: "Etherscan token page 0xE61F6e39711cEc14f8D6c637c2f4568bAA9FF7Ee read 2026-09-15 (name Hey, symbol HEY, 520 holders, links); verified source header (heytoken.pro, t.me/heyerc20, twitter.com/heyresearch); GitHub heyplatform/smart-contract commits 2022-12-02 by 'Hey Research Dev <hi@heyresearch.io>'; X post 1613594707824869376 (2023-01-12); medium.com/@heyresearch MVP update" },
      { chain: RH, address: "0xb33eb16782776b4d738c0fd643577cb0284db610", symbol: "HEY", name: "Hey Research Lab", launchedAt: "2026-09-09T17:35:06Z", venue: "pons-v2", outcome: "organic", note: "Pons V2, graduated in 7 min; 15.4% taken by seven same-block wallets at +24 and mostly dumped post-graduation; deployer 0xfdfbcae9… bought 1.53% with the launch, holds ~1.2%, used a RobinhoodLocker lock and one Relay deposit, no fee-escrow claims on its first page; 527 distinct pool buyers and 242% turnover in the first 3.4 h; ~$144k cap, ~$35k liquidity on 2026-09-14. Ongoing-selling read over 4.6 days (456% cumulative turnover): the ring and its three side wallets sold 13.8% of supply, 12.3 points of it on launch day and 0.2% in the last 24 h; the deployer never sold and is a net buyer; last 24 h was 44% sold vs 47% bought across 95 sellers, none launch-connected", evidence: "creation tx 0x53baa96a…; RPC transfer logs blocks 58729102..58849101 (launch) and 58729102..latest on 2026-09-14 (15,381 transfers); Blockscout internal txs on the ring wallets; DexScreener 2026-09-14" },
    ],
  },
  {
    id: "altcoinist-ring",
