...
export type CabalKind = "launch-farm" | "promo-ring" | "infra";
...
export const CABALS: Cabal[] = [
  ...
  },
  {
    ...
    wallets: [
      ...
      { chain: RH, address: "0x10d28597e09fec92eae3715b25967bd3d07ae335", role: "farm", label: "whitelisted seller", evidence: "top EOA holder of DOGEGPT (8.2% of supply) funded by the deployer; eth_call transfer to the pair succeeds from this wallet and reverts from every other holder tested 2026-09-14" },
    ],
    accounts: [],
    launches: [
      { chain: RH, address: "0x26becab467bf74a3e09c095c30427acbd6544608", symbol: "DOGEGPT", name: "DOGEGPT", launchedAt: "2026-09-14T01:29:00Z", venue: "direct EOA deploy, uniswap-v2 WETH", outcome: "honeypot", note: "101 buys and 0 sells in the first 6 h; non-whitelisted transfers to the pair revert; deployer holds all LP; 89 holders, ~$79k liquidity at read time", evidence: "eth_call transfer simulations from 3 holders 2026-09-14; pair LP balanceOf; DexScreener txns; Blockscout deployer tx list" },
  ...
  },
  {
    ...
    lastSeen: "2026-09-14",
    wallets: [
      { chain: RH, address: "0x2344eee2d839a83412760a0ba43e6324c34a7c5f", role: "holder-bridge", evidence: "top-50 holder of both FIH (1.68%) and WRESTLER (1.53%) on 2026-09-14" },
      { chain: RH, address: "0x2977b96b4235330075165ca5e3b0ef563745c354", role: "holder-bridge", evidence: "top-50 holder of both FIH and WRESTLER on 2026-09-14" },
      { chain: RH, address: "0xbbfd5b62d83554c57674b27aee5b8a5228ded5a5", role: "deployer", label: "FIH creator (via factory 0xd9ec2db5…)", evidence: "Blockscout getcontractcreation; 929 txs, 32.5 ETH on 2026-09-14" },
      { chain: RH, address: "0x059ae3cd996c5a0db82783224cb19ae5dc598c5e", role: "deployer", label: "WRESTLER creator (via one-shot factory 0xf86dfdb6…)", evidence: "Blockscout getcontractcreation; 114 txs" },
    ],
    accounts: [
    ...
    launches: [
      { chain: RH, address: "0x4b3a3ff4ec9d289727e24a8152f406bada44264d", symbol: "FIH", name: "Frog In Hood", launchedAt: "2026-07-01T20:44:00Z", venue: "unknown factory 0xd9ec2db5f3d1b236843925949fe5bd8a3836fccb (93k txs, unverified)", outcome: "unestablished", note: "Uniswap v3 WETH pool, ~$1.4M cap, 1,439 holders; launch window not yet read", evidence: "DexScreener pair 2026-07-01; Blockscout creator/factory 2026-09-14" },
      { chain: RH, address: "0xab528169dcc80d68837a33b1e2b866bb7d7ee301", symbol: "WRESTLER", name: "Wrestler", launchedAt: "2026-09-03T03:24:00Z", venue: "unknown one-shot factory 0xf86dfdb678d8e5d932100ef479a59fa65a82a5eb", outcome: "unestablished", note: "Uniswap v4 pool quoted in tokenized GLXY, ~$0.9M cap, 1,821 holders, $5M+ daily volume; fees stated to fund buyback-and-burn; launch window not yet read", evidence: "DexScreener pair 2026-09-03; Blockscout creator/factory 2026-09-14" },
