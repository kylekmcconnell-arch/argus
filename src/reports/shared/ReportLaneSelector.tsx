    ...
    <div className="report-view-bar border-b border-line bg-sidebar px-3 py-2 sm:px-5" data-owner-control="report-view">
      <div className="mx-auto flex max-w-[1680px] items-center gap-3">
        <div className="min-w-0">
          ...
          <p className="hidden truncate text-[11px] text-ink-dim sm:block">One saved report · three presentations</p>
        </div>
        <div className="ml-auto flex min-w-0 items-center gap-1 rounded-full border border-control-line bg-panel p-1" role="group" aria-label="Report view">
