...
describe('Report evidence accuracy regressions',()=>{
 ...
 it('routes founder identity questions to identity',()=>{const html=renderToStaticMarkup(<KyleIntelligenceDecisionCanvas {...props} successful={5} nextSteps={[{label:'Audit the founder identity'}]}/>);expect(html).toContain('Next to check: Audit the founder identity.');});
