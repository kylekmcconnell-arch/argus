...
describe('Report evidence accuracy regressions',()=>{
 ...
 it('keeps absent citation counts unknown',()=>{const html=renderToStaticMarkup(<KyleIntelligenceDecisionCanvas {...props} composition={[{axis:'T1',label:'Liquidity',score:19,weight:24,rationale:'Measured pool liquidity'}]}/>);expect(html).toContain('source-backed score inputs');expect(html).toContain('Not recorded');});
